...
$app_strings = array(
    ...
    'LBL_EMAIL_ERROR_PREPEND' => 'Ha ocurrido un error con el correo electrónico:', // PR 6752
...
$app_list_strings['aor_operator_list']['Starts_With'] = 'Empieza por';
...
$app_list_strings['aow_operator_list']['Starts_With'] = 'Empieza por';
...
$app_strings['LBL_THERE_WAS_AN_ERR'] = 'Hubo un error: '; // PR 6539

$app_strings['LBL_TO_CONTINUE'] = ' para continuar.'; // PR 6539

$app_strings['IMAP_HANDLER_ERROR'] = 'ERROR: {error}; se usó la clave: "{key}".'; // PR 6600 6617
$app_strings['IMAP_HANDLER_SUCCESS'] = 'OK: configuración de prueba cambiada a "{key}"'; // PR 6600 6617
$app_strings['IMAP_HANDLER_ERROR_INVALID_REQUEST'] = 'Petición no válida, use el valor "{var}".'; // PR 6600 6617
$app_strings['IMAP_HANDLER_ERROR_UNKNOWN_BY_KEY'] = 'Se produjo un error desconocido, la clave "{key}" no fue guardada.'; // PR 6752
$app_strings['IMAP_HANDLER_ERROR_NO_TEST_SET'] = 'No existen las configuraciones de prueba.'; // PR 6600 6617
