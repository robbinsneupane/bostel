...
class PopupSmarty extends ListViewSmarty
{
    ...
    public function _setup($file)
    {
        ...
        $params = array();
        // custom code added by Rupendra for task #20211015-02
        // custom where added for popup view 
        if (isset($_REQUEST['custom_where']) && !empty($_REQUEST['custom_where'])) {
            $params['custom_where'] = $_REQUEST['custom_where'];
        }
