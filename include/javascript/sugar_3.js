...
sugarListView.get_num_selected=function(){if(typeof document.MassUpdate != 'undefined'){var selectCount=sugarListView.get_checks_count();if(selectCount>0)
...
sugarListView.get_checks_count=function(){ar=new Array();if(typeof document.MassUpdate != 'undefined'&&document.MassUpdate.uid.value!=''){oldUids=document.MassUpdate.uid.value.split(',');for(uid in oldUids){if(typeof(oldUids[uid])!='function'){ar[oldUids[uid]]=1;}}}
