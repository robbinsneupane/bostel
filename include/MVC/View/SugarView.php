...
class SugarView
{
    ...
    public function displayHeader($retModTabs = false)
    {
        ...
        // fetching Client id Custom changes as requirmentse
        // echo "<pre>"; print_r($current_user->id);
        // global $db;
        // $sql = "SELECT name,securitygroups_users.user_id from securitygroups
        //         left join securitygroups_users on securitygroups_users.securitygroup_id = securitygroups.id";
        //         //where securitygroups_users.user_id = '".$current_user->id."'";
        // echo "$sql";
