...
function get_form() {
  ...
  //custom code for remove prev. popups start
  if ($('#dialog1_mask').length > 0) {
    $('#dialog1_mask').remove();
  }
  if ($('#dialog1_c').length > 0) {
    $('#dialog1_c').remove();
  }
  //custom code for remove prev. popups end
  ...
  var callback = {
    ...
    success: function (result) {
      ...
      var manageCalendar = function () {
        ...
        //custom code for remove prev. calendar start
        if ($('#container_date_start_trigger').length > 0) {
          $('#container_date_start_trigger').remove();
        }
        //custom code for remove prev. calendar end
