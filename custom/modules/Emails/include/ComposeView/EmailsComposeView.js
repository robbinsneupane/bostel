...
(function ($) {
  ...
  $.fn.EmailsComposeView = function (options) {
    ...
    self.handleQTipBarClick = function () {
      ...
      var popupWindow = open_popup_modal(
        ...
        $.ajax({
          ...
          if (typeof json.data !== "undefined") {
            $(json.data).each(function (i, v) {
              ...
              selectOption.attr('infos', '(<b>' + SUGAR.language.translate('Emails', 'LBL_REPLY_TO') + ':</b> ' + v.attributes.reply_to + ', <b>' + SUGAR.language.translate('Emails', 'LBL_FROM') + ':</b> ' + v.attributes.from + ')');
  ...
  $.fn.EmailsComposeView.defaults = {
    "tinyMceOptions": {
      ...
      language: (current_lang != 'en_us') ? current_lang : false
    }
  };
}(jQuery));
