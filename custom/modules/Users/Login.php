...
// unset($_REQUEST['ck_login_language_20']); // emoving ck_login_language_20 from request
if(isset($_COOKIE['ck_login_language_20'])){
    $lang = $current_language = $_COOKIE['ck_login_language_20'];
...
$login_image = '<IMG src="' . $login_image_url . '" alt="BostelCRM" style="margin: 5px 0;">';
...
// added CUSTOMER_ID_ERROR when wrong CUSTOMER ID
if (isset($_COOKIE['customerIDErrorMessage'])) {
    $sugar_smarty->assign('CUSTOMER_ID_ERROR', $_COOKIE['customerIDErrorMessage']);
}
...
$sugar_smarty->assign('DISPLAY_LANGUAGE', $display_language);
...
// added type for when a user redirect this page as a agent, Added by Rupendra/25-04-20
if (isset($_REQUEST['type'])) {
    $sugar_smarty->assign('LOGIN_TYPE', $_REQUEST['type']);
}
