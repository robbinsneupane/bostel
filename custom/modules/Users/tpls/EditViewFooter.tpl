                        ...
                        <div id='generate_password_old_password' {if ($IS_ADMIN && !$ADMIN_EDIT_SELF)} style='display:none' {/if}>
                            ...
                            <table width='100%' cellspacing='0' cellpadding='0' border='0'>
                                <tr>
                                    ...
                                    <td>
                                        <input autocomplete="new-password" name='old_password' id='old_password' type='password' tabindex='2'
            ...
            <tr>
                ...
                <td valign="top" nowrap>
                    <!--
								...
								-->
                    <slot>{include file="custom/modules/Reminders/tpls/remindersDefaults.tpl"}</slot>
                </td>
                {/if}
            </tr>
