...
class UsersViewEdit extends ViewEdit
{
    ...
    public function display()
    {
        ...
        if(!$current_user->is_admin){
            unset($this->ev->defs['panels']['LBL_USER_INFORMATION'][2]);
            unset($this->ev->defs['panels']['LBL_USER_INFORMATION'][3]);
            unset($this->ev->defs['panels']['LBL_USER_INFORMATION'][4]);
        }
...
EOD
        ;
        // $action_button_header = array_merge($action_button_header, $this->ss->get_template_vars('BUTTONS_HEADER')); // as no need both buttons code commented by Rupendra/25-04-20
...
EOD
        ;
        // $action_button_footer = array_merge($action_button_footer, $this->ss->get_template_vars('BUTTONS_FOOTER')); // as no need both buttons code commented by Rupendra/25-04-20
