...
class UsersViewDetail extends ViewDetail
{
    ...
    public function preDisplay()
    {
        ...
        $show_roles = false; // no need to show for other uuer as well
    ...
    public function display()
    {
        ...
        if(!$current_user->is_admin){
            $this->dv->defs['panels']['LBL_USER_INFORMATION'][1][1] = '';
            unset($this->dv->defs['panels']['LBL_USER_INFORMATION'][2]);
        }
        ...
        // echo "<pre>"; print_r($this->dv->defs['templateMeta']['form']['buttons']);
        $this->dv->process();
