...
function openProductPopup(ln) {
  ...
  open_popup_modal('AOS_Products', popupRequestData);
...
function calculateLine(ln, key) {
  ...
  // commented as #20201007-09 service without description should count
...
function calculateTotal(key) {
  ...
  tax += parseFloat(shippingtax_amt);
...
function unformat2Number(num) {
  ...
  // custom changes
  let val = unformatNumber(num, num_grp_sep, dec_sep);
