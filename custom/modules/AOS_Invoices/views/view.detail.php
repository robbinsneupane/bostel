...
class AOS_InvoicesViewDetail extends ViewDetail
{
    ...
    public function populateInvoiceTemplates()
    {
        ...
        WHERE template.deleted=0 AND template.type='AOS_Invoices' AND template.active = 1
    ...
    public function displayPopupHtml()
    {
        ...
        if ($templatesList) {
            ...
            echo $template->fetch('modules/AOS_Invoices/templates/showPopupWithTemplates.tpl');
        } else {
            echo '<script>
