...
{assign var="excludePlusIcon" value=','|explode:"Home,Calendar,SecurityGroups,Users,Employees,Emails"}
{assign var="excludeMenu" value=','|explode:"Emails,AOS_Product_Categories,AOS_PDF_Templates,AOS_Products,Users,MySettings"}
                ...
                {foreach from=$groupTabs item=modules key=group name=groupList}
                    {if $smarty.foreach.groupList.last}
                        ...
                        {foreach from=$modules.modules item=module key=modulekey}
                            {if !($modulekey|in_array:$excludeMenu)}
                                {if $modulekey =='Home'}
                                    <li>
                                        <a href="index.php?module=Home&action=mobile" id="moduleTab_9_Home" module="Home">
                                        {sugar_translate module="Home" label="LBL_MODULE_NAME"}
                                        </a>
                                    </li>
                                {/if}
                                {if $modulekey !='Home'}
                                    <li role="presentation" >
                                        ...
                                        {if !($modulekey|in_array:$excludePlusIcon)}
                                        ...
                                        <li class="mobile-current-actions" role="presentation">
                                           <ul class="mobileCurrentTab">
                                               {foreach from=$shortcutTopMenu.$name item=item}
                                                   ...
                                                   {else}
                                                        {if ($item.MODULE_NAME|strstr:"Security_Group") === false  || $CURRENT_USER_ID == 1}
                            ...
                            {if $name != 'Home'}
                                <li class="topnav">
                                    ...
                                    <span class="currentTab">
                                        {if !($name|in_array:$excludeMenu)}
                                            {sugar_link id="moduleTab_$name" module=$name data=$module}
                                        {else}
                                            <a href="javascript:;" id="moduleTab_{$name}">{sugar_translate module=$name label="LBL_MODULE_NAME"}</a>
                                        {/if}
                                    </span>
                                    <span>&nbsp;</span>
                    ...
                    {foreach from=$groupTabs item=modules key=group name=groupList}
                        ...
                        <li class="topnav {if $smarty.foreach.groupList.last}all{/if}">
                            ...
                            <ul class="dropdown-menu" role="menu" {if $smarty.foreach.groupList.last} class="All"{/if}>
                                ...
                                {/foreach}
                                {foreach from=$modules.extra item=submodulename key=submodule}
                                    {if !($submodulename|in_array:$excludeMenu)  && $submodule != 'MySettings'}
                                        <li>
            ...
            <ul id="toolbar" class="toolbar">
                ...
                <li id="quickcreatetop" class="create dropdown nav navbar-nav quickcreatetop">
                    ...
                    <ul class="dropdown-menu" role="menu">
                       <li><a href="index.php?module=Contacts&action=EditView&return_module=Contacts&return_action=DetailView">{$APP.LBL_QUICK_CREATE}{sugar_translate module="Contacts" label="LBL_MODULE_NAME"}</a></li>
                        ...
                        <li><a href="index.php?module=Project&action=EditView&return_module=Project&return_action=DetailView">{$APP.LBL_QUICK_CREATE}{sugar_translate module="Project" label="LBL_MODULE_NAME"}</a></li>
                        ...
                        <li><a href="index.php?module=Notes&action=EditView&return_module=Notes&return_action=DetailView">{$APP.LBL_QUICK_CREATE}{sugar_translate module="Notes" label="LBL_MODULE_NAME"}</a></li>
                        ...
                        <li><a href="index.php?module=AOS_Quotes&action=EditView&return_module=AOS_Quotes&return_action=DetailView">{$APP.LBL_QUICK_CREATE}{sugar_translate module="AOS_Quotes" label="LBL_MODULE_NAME"}</a></li>
                        <li><a href="index.php?module=AOS_Invoices&action=EditView&return_module=AOS_Invoices&return_action=DetailView">{$APP.LBL_QUICK_CREATE}{sugar_translate module="AOS_Invoices" label="LBL_MODULE_NAME"}</a></li>
                ...
                <li id="globalLinks" class="dropdown nav navbar-nav globalLinks-mobile">
                    ...
                    <ul class="dropdown-menu user-dropdown user-menu" role="menu" aria-labelledby="dropdownMenu2">
                        ...
                        {/foreach}
                        <li role="presentation"><a role="menuitem" id="logout_link" href="javascript:;" data-href='{$LOGOUT_LINK}'
        ...
        <div class="desktop-bar">
            <ul id="toolbar" class="toolbar">
                ...
                <li id="globalLinks" class="dropdown nav navbar-nav globalLinks-desktop">
                    <button id="with-label" class="dropdown-toggle user-menu-button pb-5" title="{$CURRENT_USER}"data-toggle="dropdown" aria-expanded="true">
                        <span class="suitepicon suitepicon-action-current-user"></span>
                    ...
                    <ul class="dropdown-menu user-dropdown user-menu" role="menu" aria-labelledby="with-label">
                        ...
                        {foreach from=$GCLS item=GCL name=gcl key=gcl_key}
                            <li role="presentation">
                                <a id="{$gcl_key}_link" {if $gcl_key == 'training'} target="_blank"  {/if}
                                   href="{$GCL.URL}"{if !empty($GCL.ONCLICK)} onclick="{$GCL.ONCLICK}"{/if}>{$GCL.LABEL}</a>
                            </li>
                        {/foreach}
                        <li role="presentation"><a role="menuitem" id="logout_link" href="javascript:;" data-href='{$LOGOUT_LINK}'
