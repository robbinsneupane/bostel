    ...
    <div id="loginform">
		...
		{sugar_translate label="WARN_BROWSER_IE_COMPATIBILITY_MODE_WARNING"}
            ...
            {if $CUSTOMER_ID_ERROR !=''}
                <span class="error">{$CUSTOMER_ID_ERROR}</span>
            {/if}
            ...
            <input type="hidden" id="login_language" name="login_language" value="{$DISPLAY_LANGUAGE}">
           ...
           {if $LOGIN_TYPE == 'agent'}
                <div class="input-group">
                <input type="text" class="form-control"
                       placeholder="{sugar_translate module="Users" label="LBL_GROUP"}" tabindex="3"
