   	  ...
   	  switch(strtoupper($type)) {
			...
			case "AUDIT":
	            ...
	            $encoded_popup_request_data = MetaParser::parseDelimiters($json->encode($popup_request_data));
	 			$audit_link = '<a id="btn_view_change_log" title="{$APP.LNK_VIEW_CHANGE_LOG}" onclick=\'open_popup_modal("Audit", ' . $encoded_popup_request_data . ', "", false, "&record={$fields.id.value}&module_name=' . $params['module'] . '"); return false;\'>{$APP.LNK_VIEW_CHANGE_LOG}</a>';
