    ...
    if (!is_array($type)) {
        ...
        switch (strtoupper($type)) {
            ...
            case "AUDIT":
                ...
                $audit_link = '<input id="btn_view_change_log" title="{$APP.LNK_VIEW_CHANGE_LOG}" class="button" onclick=\'open_popup_modal("Audit", ' . $encoded_popup_request_data . ', "", false, "&record={$fields.id.value}&module_name=' . $params['module'] . '"); return false;\' type="button" value="{$APP.LNK_VIEW_CHANGE_LOG}">';
