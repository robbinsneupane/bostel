...
{if count($data) == 0}
	...
	<div class="list view listViewEmpty">
        ...
        {if strlen($query) == 0 || $query == "-advanced_search"}
                ...
                <p class="msg">
                    ...
                    {$APP.MSG_EMPTY_LIST_VIEW_NO_RESULTS|replace:"<item2>":$createLink|replace:"or <item3>":""}
                </p>
...
{if $hideTable == false}
    ...
    {include file='custom/include/ListView/ListViewPaginationBottom.tpl'}
	</tfoot>
	</table></div>
{/if}
{if $contextMenus}
