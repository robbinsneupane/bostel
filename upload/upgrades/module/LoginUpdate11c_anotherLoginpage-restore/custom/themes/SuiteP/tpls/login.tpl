...
<div class="p_login">
	...
	<div class="p_login_top">
		...
		<a title="BostelCRM" href="http://www.bostel.com">BostelCRM
            <img src="public/bostellogolg.png" />
        </a>
    ...
    <div id="loginform">
        ...
        <form class="form-signin" role="form" action="index.php" method="post" name="DetailView" id="form"
            ...
            <div class="companylogo">
                <img src="public/bostellogolg.png" alt="BostelCRM" style="margin: 5px 0; height:75px;">
            </div>
