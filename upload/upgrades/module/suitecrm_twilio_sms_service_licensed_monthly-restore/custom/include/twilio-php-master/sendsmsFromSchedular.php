 ...
 * Description: Send SMS from Scheduler Action
 * 
 */
			...
			try{
				$message = $client->messages->create(
				  ...
				  array(
					...
					'body' => $smsBody,
					'statusCallback' => $siteUrl."/index.php?entryPoint=statusCallBack&bean_module=".$note_parent_type."&bean_id=".$note_parent_id."&body=".rawurlencode($smsBody)."&in_schedular=true&suite_sms_id=".$suite_sms_id."&segment=".$segment
