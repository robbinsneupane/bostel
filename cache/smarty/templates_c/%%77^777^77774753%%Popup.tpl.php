...
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_getjspath', 'cache/themes/SuiteP/modules/Users/Popup.tpl', 11, false),array('function', 'counter', 'cache/themes/SuiteP/modules/Users/Popup.tpl', 75, false),array('function', 'sugar_translate', 'cache/themes/SuiteP/modules/Users/Popup.tpl', 84, false),array('function', 'sugar_action_menu', 'cache/themes/SuiteP/modules/Users/Popup.tpl', 116, false),array('function', 'sugar_evalcolumn_old', 'cache/themes/SuiteP/modules/Users/Popup.tpl', 199, false),array('function', 'sugar_currency_format', 'cache/themes/SuiteP/modules/Users/Popup.tpl', 201, false),array('function', 'multienum_to_array', 'cache/themes/SuiteP/modules/Users/Popup.tpl', 216, false),array('function', 'sugar_field', 'cache/themes/SuiteP/modules/Users/Popup.tpl', 222, false),array('modifier', 'default', 'cache/themes/SuiteP/modules/Users/Popup.tpl', 79, false),array('modifier', 'lower', 'cache/themes/SuiteP/modules/Users/Popup.tpl', 82, false),)), $this); ?>
...
'>
	                <?php if (((is_array($_tmp=@$this->_tpl_vars['params']['sortable'])) ? $this->_run_mod_handler('default', true, $_tmp, true) : smarty_modifier_default($_tmp, true))): ?>
                                								<a href="javascript:;" onclick='paginateList("<?php echo $this->_tpl_vars['pageData']['urls']['orderBy']; ?>
...
' class='button' <?php if ($this->_tpl_vars['prerow']): ?>onclick='paginateList("<?php echo $this->_tpl_vars['pageData']['urls']['startPage']; ?>
", true)'<?php else: ?> onClick='paginateList("<?php echo $this->_tpl_vars['pageData']['urls']['startPage']; ?>
")' <?php endif; ?>>
...
' class='button' <?php if ($this->_tpl_vars['prerow']): ?>onclick='paginateList("<?php echo $this->_tpl_vars['pageData']['urls']['prevPage']; ?>
", true)' <?php else: ?> onClick='paginateList("<?php echo $this->_tpl_vars['pageData']['urls']['prevPage']; ?>
")'<?php endif; ?>>
...
' class='button' <?php if ($this->_tpl_vars['prerow']): ?>onclick='paginateList("<?php echo $this->_tpl_vars['pageData']['urls']['nextPage']; ?>
", true)' <?php else: ?> onClick='paginateList("<?php echo $this->_tpl_vars['pageData']['urls']['nextPage']; ?>
")'<?php endif; ?>>
...
' class='button' <?php if ($this->_tpl_vars['prerow']): ?>onclick='paginateList("<?php echo $this->_tpl_vars['pageData']['urls']['endPage']; ?>
"), true' <?php else: ?> onClick='paginateList("<?php echo $this->_tpl_vars['pageData']['urls']['endPage']; ?>
")'<?php endif; ?>>
...
'>
 ...
 href='javascript:void(0)' onclick="send_back_modal('<?php if ($this->_tpl_vars['params']['dynamic_module']): ?><?php echo $this->_tpl_vars['rowData'][$this->_tpl_vars['params']['dynamic_module']]; ?>
