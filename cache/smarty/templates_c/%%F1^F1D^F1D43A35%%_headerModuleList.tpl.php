<?php /* Smarty version 2.6.31, created on 2023-04-14 02:07:14
         compiled from custom/themes/SuiteP/tpls/_headerModuleList.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'explode', 'custom/themes/SuiteP/tpls/_headerModuleList.tpl', 42, false),array('modifier', 'in_array', 'custom/themes/SuiteP/tpls/_headerModuleList.tpl', 58, false),array('modifier', 'strstr', 'custom/themes/SuiteP/tpls/_headerModuleList.tpl', 110, false),array('modifier', 'lower', 'custom/themes/SuiteP/tpls/_headerModuleList.tpl', 134, false),array('modifier', 'replace', 'custom/themes/SuiteP/tpls/_headerModuleList.tpl', 134, false),array('modifier', 'default', 'custom/themes/SuiteP/tpls/_headerModuleList.tpl', 836, false),array('function', 'sugar_translate', 'custom/themes/SuiteP/tpls/_headerModuleList.tpl', 62, false),array('function', 'sugar_link', 'custom/themes/SuiteP/tpls/_headerModuleList.tpl', 69, false),array('function', 'counter', 'custom/themes/SuiteP/tpls/_headerModuleList.tpl', 253, false),array('function', 'search_controller', 'custom/themes/SuiteP/tpls/_headerModuleList.tpl', 581, false),)), $this); ?>
<!--Start Responsive Top Navigation Menu -->
<?php $this->assign('excludePlusIcon', ((is_array($_tmp=',')) ? $this->_run_mod_handler('explode', true, $_tmp, "Home,Calendar,SecurityGroups,Users,Employees,Emails") : explode($_tmp, "Home,Calendar,SecurityGroups,Users,Employees,Emails"))); ?>
<?php $this->assign('excludeMenu', ((is_array($_tmp=',')) ? $this->_run_mod_handler('explode', true, $_tmp, "Emails,AOS_Product_Categories,AOS_PDF_Templates,AOS_Products,Users,MySettings") : explode($_tmp, "Emails,AOS_Product_Categories,AOS_PDF_Templates,AOS_Products,Users,MySettings"))); ?>
...
?>
                            <?php if (! ( ((is_array($_tmp=$this->_tpl_vars['modulekey'])) ? $this->_run_mod_handler('in_array', true, $_tmp, $this->_tpl_vars['excludeMenu']) : smarty_modifier_in_array($_tmp, $this->_tpl_vars['excludeMenu'])) )): ?>
                                <?php if ($this->_tpl_vars['modulekey'] == 'Home'): ?>
                                    <li>
                                        <a href="index.php?module=Home&action=mobile" id="moduleTab_9_Home" module="Home">
                                        <?php echo smarty_function_sugar_translate(array('module' => 'Home','label' => 'LBL_MODULE_NAME'), $this);?>
...
'">
                                        ...
                                        <?php if (! ( ((is_array($_tmp=$this->_tpl_vars['modulekey'])) ? $this->_run_mod_handler('in_array', true, $_tmp, $this->_tpl_vars['excludePlusIcon']) : smarty_modifier_in_array($_tmp, $this->_tpl_vars['excludePlusIcon'])) )): ?>
...
?>
                            <?php if (! ( ((is_array($_tmp=$this->_tpl_vars['submodule'])) ? $this->_run_mod_handler('in_array', true, $_tmp, $this->_tpl_vars['excludeMenu']) : smarty_modifier_in_array($_tmp, $this->_tpl_vars['excludeMenu'])) ) && $this->_tpl_vars['submodule'] != 'MySettings'): ?>
                                <li role="presentation" >
...
'">
                                    ...
                                    <?php if (! ( ((is_array($_tmp=$this->_tpl_vars['submodule'])) ? $this->_run_mod_handler('in_array', true, $_tmp, $this->_tpl_vars['excludePlusIcon']) : smarty_modifier_in_array($_tmp, $this->_tpl_vars['excludePlusIcon'])) )): ?>   
...
?>
                                                   ...
                                                   <?php else: ?>
                                                        <?php if (( ((is_array($_tmp=$this->_tpl_vars['item']['MODULE_NAME'])) ? $this->_run_mod_handler('strstr', true, $_tmp, 'Security_Group') : strstr($_tmp, 'Security_Group')) ) === false || $this->_tpl_vars['CURRENT_USER_ID'] == 1): ?>
...
" class="favorite-links-edit"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></a>
            ...
            <div class="mobileheader">
                <h4 class="recent_h3 group_name custom-desktop" style>
                    <?php 
                        // including a php script directly from the template.
                        include('custom/modules/Users/CustomSecurityGroupName.php');
                     ?>
                </h4>
            </div>
            <div class="topmenu">
                <img src="public/bostellogolg.png" class="logo" />
            </div>
        </div>
        <div class="navbar-header custom-group-name-header">
            <div class="mobileheader" style="width:100%">
                <h2 class="recent_h3 group_name" style>
                    <?php 
                        // including a php script directly from the template.
                        include('custom/modules/Users/CustomSecurityGroupName.php');
                     ?>
            ...
            <?php if ($this->_tpl_vars['USE_GROUP_TABS']): ?>
                <ul class="nav navbar-nav">
                    <li class="navbar-brand-container">
                            <a class="navbar-brand with-home-icon suitepicon suitepicon-action-home" href="index.php?module=Home&action=mobile"></a>
                    </li>
                            ...
                            <?php if ($this->_tpl_vars['name'] != 'Home'): ?>
                                <li class="topnav">
                                    ...
                                    <span class="currentTab">
                                        <?php if (! ( ((is_array($_tmp=$this->_tpl_vars['name'])) ? $this->_run_mod_handler('in_array', true, $_tmp, $this->_tpl_vars['excludeMenu']) : smarty_modifier_in_array($_tmp, $this->_tpl_vars['excludeMenu'])) )): ?>
                                        ...
                                        <?php else: ?>
                                            <a href="javascript:;" id="moduleTab_<?php echo $this->_tpl_vars['name']; ?>
"><?php echo smarty_function_sugar_translate(array('module' => $this->_tpl_vars['name'],'label' => 'LBL_MODULE_NAME'), $this);?>
</a>
                                        <?php endif; ?>
                                    </span>
                                    <span>&nbsp;</span>
...
<?php $this->_smarty_vars['capture']['moduleTabId'] = ob_get_contents();  $this->assign('moduleTabId', ob_get_contents());ob_end_clean(); ?>
    ...
    foreach ($_from as $this->_tpl_vars['submodule'] => $this->_tpl_vars['submodulename']):
?>
                                    <?php if (! ( ((is_array($_tmp=$this->_tpl_vars['submodulename'])) ? $this->_run_mod_handler('in_array', true, $_tmp, $this->_tpl_vars['excludeMenu']) : smarty_modifier_in_array($_tmp, $this->_tpl_vars['excludeMenu'])) ) && $this->_tpl_vars['submodule'] != 'MySettings'): ?>
                                        <li>
...
"><?php echo $this->_tpl_vars['submodulename']; ?>
            ...
            <?php else: ?>
                ...
                <ul class="nav navbar-nav navbar-horizontal-fluid">
                    <li class="navbar-brand-container">
                        <a class="navbar-brand with-home-icon" href="index.php?module=Home&action=mobile">
...
"><?php echo $this->_tpl_vars['submodulename']; ?>
            ...
            <?php endif; ?>
             ...
             <ul class="nav navbar-horizontal-fluid">
                <li class="">
                    <h4 class="recent_h3 group_name" style>
                        <?php 
                            // including a php script directly from the template.
                            include('custom/modules/Users/CustomSecurityGroupName.php');
                         ?>
        ...
        <div class="mobile-bar">
            <ul id="toolbar" class="toolbar">
                <li id="homeQuickLink" class="">
                    <a href="index.php?module=Home&action=mobile" >
                        <?php echo smarty_function_sugar_translate(array('module' => 'Home','label' => 'LBL_MODULE_NAME'), $this);?>
...
<?php echo smarty_function_sugar_translate(array('module' => 'Calls','label' => 'LBL_MODULE_NAME'), $this);?>
                        ...
                        <li><a href="index.php?module=Project&action=EditView&return_module=Project&return_action=DetailView"><?php echo $this->_tpl_vars['APP']['LBL_QUICK_CREATE']; ?>
<?php echo smarty_function_sugar_translate(array('module' => 'Project','label' => 'LBL_MODULE_NAME'), $this);?>
</a></li>
...
<?php echo smarty_function_sugar_translate(array('module' => 'Meetings','label' => 'LBL_MODULE_NAME'), $this);?>
                        ...
                        <li><a href="index.php?module=Notes&action=EditView&return_module=Notes&return_action=DetailView"><?php echo $this->_tpl_vars['APP']['LBL_QUICK_CREATE']; ?>
<?php echo smarty_function_sugar_translate(array('module' => 'Notes','label' => 'LBL_MODULE_NAME'), $this);?>
</a></li>
...
<?php echo smarty_function_sugar_translate(array('module' => 'Opportunities','label' => 'LBL_MODULE_NAME'), $this);?>
                        ...
                        <li><a href="index.php?module=AOS_Quotes&action=EditView&return_module=AOS_Quotes&return_action=DetailView"><?php echo $this->_tpl_vars['APP']['LBL_QUICK_CREATE']; ?>
<?php echo smarty_function_sugar_translate(array('module' => 'AOS_Quotes','label' => 'LBL_MODULE_NAME'), $this);?>
</a></li>
                        <li><a href="index.php?module=AOS_Invoices&action=EditView&return_module=AOS_Invoices&return_action=DetailView"><?php echo $this->_tpl_vars['APP']['LBL_QUICK_CREATE']; ?>
<?php echo smarty_function_sugar_translate(array('module' => 'AOS_Invoices','label' => 'LBL_MODULE_NAME'), $this);?>
</a></li>
                        <li><a href="index.php?module=Cases&action=EditView&return_module=Cases&return_action=DetailView"><?php echo $this->_tpl_vars['APP']['LBL_QUICK_CREATE']; ?>
<?php echo smarty_function_sugar_translate(array('module' => 'Cases','label' => 'LBL_MODULE_NAME'), $this);?>
</a></li>
                    </ul>
                </li>
...
"/>
                ...
                <li id="desktop_sms" class="dropdown nav navbar-nav desktop_notifications">
...
"<?php endif; ?>><?php echo $this->_tpl_vars['GCL']['LABEL']; ?>
                        ...
                        <?php endforeach; endif; unset($_from); ?>
                        <li role="presentation"><a role="menuitem" id="logout_link" href="javascript:;" data-href='<?php echo $this->_tpl_vars['LOGOUT_LINK']; ?>
'
...
"/>
                ...
                <li id="desktop_notifications" class="dropdown nav navbar-nav desktop_notifications">
                    <button class="alertsButton btn dropdown-toggle suitepicon suitepicon-action-alerts pb-5" data-toggle="dropdown"
                            aria-expanded="false">
                        <span class="alert_count hidden">0</span>
                    </button>
                    <div id="alerts" class="dropdown-menu" role="menu"><?php echo $this->_tpl_vars['APP']['LBL_EMAIL_ERROR_VIEW_RAW_SOURCE']; ?>
                ...
                <li id="globalLinks" class="dropdown nav navbar-nav globalLinks-desktop">
                    <button id="with-label" class="dropdown-toggle user-menu-button pb-5" title="<?php echo $this->_tpl_vars['CURRENT_USER']; ?>
...
?>
                            <li role="presentation">
                                <a id="<?php echo $this->_tpl_vars['gcl_key']; ?>
_link" <?php if ($this->_tpl_vars['gcl_key'] == 'training'): ?> target="_blank"  <?php endif; ?>
                                   href="<?php echo $this->_tpl_vars['GCL']['URL']; ?>
"<?php if (! empty ( $this->_tpl_vars['GCL']['ONCLICK'] )): ?> onclick="<?php echo $this->_tpl_vars['GCL']['ONCLICK']; ?>
"<?php endif; ?>><?php echo $this->_tpl_vars['GCL']['LABEL']; ?>
</a>
