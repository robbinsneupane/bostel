...
" class="button" onclick='open_popup_modal("Audit",  { "call_back_function":"set_return","form_name":"EditView","field_to_name_array":[] } , "", false, "&record=<?php echo $this->_tpl_vars['fields']['id']['value']; ?>
&module_name=Notes"); return false;' type="button" value="<?php echo $this->_tpl_vars['APP']['LNK_VIEW_CHANGE_LOG']; ?>
"><?php endif; ?><?php endif; ?>
</div>
</td>
...
" onclick='open_popup_modal(document.<?php echo $this->_tpl_vars['form_name']; ?>
.parent_type.value, <?php echo '{"call_back_function":"set_return","form_name":"form_SubpanelQuickCreate_Notes","field_to_name_array":{"id":"parent_id","name":"parent_name"}}'; ?>
...
<script type="text/javascript" src='include/SugarFields/Fields/File/SugarFieldFile.js?v=z3EBepyLpk_UL5grYYm2VA'></script>
...
<?php echo '\' );
addToValidate(\'form_SubpanelQuickCreate_Notes\', \'attachments\', \'text\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_ATTACHMENTS','module' => 'Notes','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'form_SubpanelQuickCreate_Notes\', \'attachments_view\', \'function\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_ATTACHMENTS','module' => 'Notes','for_js' => true), $this);?>
<?php echo '\' );
