...
<div class="p_login">
	...
	<div class="p_login_top">
		...
		<a title="BostelCRM" href="http://crm.bostel.com/">BostelCRM</a>
    ...
    <div id="loginform">
		...
		<?php echo smarty_function_sugar_translate(array('label' => 'WARN_BROWSER_IE_COMPATIBILITY_MODE_WARNING'), $this);?>
            ...
            <?php endif; ?>
            <?php if ($this->_tpl_vars['CUSTOMER_ID_ERROR'] != ''): ?>
                <span class="error"><?php echo $this->_tpl_vars['CUSTOMER_ID_ERROR']; ?>
</span>
            <?php endif; ?>
            ...
            <input type="hidden" id="login_language" name="login_language" value="<?php echo $this->_tpl_vars['DISPLAY_LANGUAGE']; ?>
">
...
' autocomplete="off">
                <span class="input-group-icon">
                    ...
                    <i style="display:none" class="fas fa-eye-slash"></i>
                </span>
            </div>
            <br>

           <?php if ($this->_tpl_vars['LOGIN_TYPE'] == 'agent'): ?>
                <div class="input-group">
                <input type="text" class="form-control"
                       placeholder="<?php echo smarty_function_sugar_translate(array('module' => 'Users','label' => 'LBL_GROUP'), $this);?>
" tabindex="3"
                       id="user_group" name="user_group" autocomplete="off">
                </div>
                <br>
            <?php endif; ?>
...
:
        ...
        <br/>
        <div>
            To learn more about Bostel CRM features <a target="_blank" href="https://bostel.com/index.php/bostelcrm?browser=demo.pdf">Click Here</a>.
        </div>
        <div>
            To Subscribe for a 10 day FREE account <a target="_blank" href="https://bostel.com/index.php/plans-pricing/subscribe?group_id=12&browser=demo.pdf">Click Here</a>.
        </div>
        <div>
            Test drive live demo account by <a target="_blank" href="https://www.bostel.com/index.php/bostelcrm-demo?browser=demo.pdf">Clicking Here</a>.
        </div>
    ...
    <div class="p_login_bottom">
    		...
    		<a id="admin_options">&copy; Supercharged by BostelCRM</a>
