...
<input type="button" class="button" onClick="window.location='index.php?module=Activities&action=Popup&query=true&record={$fields.id.value}&module_name=Contacts&mode=single&create=false'" value="{$APP.LBL_VIEW_SUMMARY}"/>
...
<li><input type="button" class="button" onClick="window.location='index.php?module=Activities&action=Popup&query=true&record={$fields.id.value}&module_name=Contacts&mode=single&create=false'" value="{$APP.LBL_VIEW_SUMMARY}"/></li>
...
<li>{if $bean->aclAccess("detail")}{if !empty($fields.id.value) && $isAuditEnabled}<input id="btn_view_change_log" title="{$APP.LNK_VIEW_CHANGE_LOG}" class="button" onclick='open_popup_modal("Audit",  {ldelim} "call_back_function":"set_return","form_name":"EditView","field_to_name_array":[] {rdelim} , "", false, "&record={$fields.id.value}&module_name=Contacts"); return false;' type="button" value="{$APP.LNK_VIEW_CHANGE_LOG}">{/if}{/if}</li>
</ul>        </li>
...
{capture name="label" assign="label"}{sugar_translate label='LBL_CATEGORY' module='Contacts'}{/capture}
...
{if !empty($fields.category_id.value)}
{capture assign="detail_url"}index.php?module=ru_Contact_Categories&action=DetailView&record={$fields.category_id.value}{/capture}
<a href="{sugar_ajax_url url=$detail_url}">{/if}
<span id="category_id" class="sugar_field" data-id-value="{$fields.category_id.value}">{$fields.category_name.value}</span>
...
{/if} 
<span class="sugar_field" id="{$fields.company_name.name}">{$fields.company_name.value}</span>
{/if}
...
{sugar_phone value="<a href=\"tel:$phone_value\">$phone_value</a>" usa_format="0"}
{/if}
{/if}
...
{capture name="label" assign="label"}{sugar_translate label='LBL_WEBSITE' module='Contacts'}{/capture}
{$label|strip_semicolon}:
</div>
...
{$fields.primary_company_name.value|escape:'html_entity_decode'|escape:'html'|url2html|nl2br}
<br>
...
{$fields.alt_company_name.value|escape:'html_entity_decode'|escape:'html'|url2html|nl2br}
<br>
