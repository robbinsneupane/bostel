...
{sugar_translate label='LBL_LIST_RELATED_TO'} {sugar_translate label='LBL_MODULE_NAME' module=$fields.parent_type.value}
</div>
...
{if !$fields.attachments_view.hidden}
{counter name="panelFieldCount" print=false}
<span id='attachments_view_span'>
{$fields.attachments_view.value}
</span>
{/if}
