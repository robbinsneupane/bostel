...
<div class="col-xs-12 col-sm-2 label" data-label="LBL_ATTACHMENTS">

{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_ATTACHMENTS' module='Notes'}{/capture}
{$label|strip_semicolon}:

{/minify}
</div>

<div class="col-xs-12 col-sm-8 edit-view-field " type="function" field="attachments_view" colspan='3' >
{counter name="panelFieldCount" print=false}
<span id='attachments_view_span'>
{$fields.attachments_view.value}</span>
</div>
...
addToValidate('EditView', 'attachments', 'text', false,'{/literal}{sugar_translate label='LBL_ATTACHMENTS' module='Notes' for_js=true}{literal}' );
addToValidate('EditView', 'attachments_view', 'function', false,'{/literal}{sugar_translate label='LBL_ATTACHMENTS' module='Notes' for_js=true}{literal}' );
