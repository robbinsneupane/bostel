...
addToValidate('form_SubpanelQuickCreate_Notes', 'attachments', 'text', false,'{/literal}{sugar_translate label='LBL_ATTACHMENTS' module='Notes' for_js=true}{literal}' );
addToValidate('form_SubpanelQuickCreate_Notes', 'attachments_view', 'function', false,'{/literal}{sugar_translate label='LBL_ATTACHMENTS' module='Notes' for_js=true}{literal}' );
