...
$outfitters_config = array(
    'name' => 'SuiteCRM_TwilioSMS_Service', //The matches the id value in your manifest file. This allow the library to lookup addon version from upgrade_history, so you can see what version of addon your customers are using
    'shortname' => 'suitecrm_twiliosms_service', //The short name of the Add-on. e.g. For the url https://www.sugaroutfitters.com/addons/sugaroutfitters the shortname would be sugaroutfitters
    'public_key' => 'e9ede9b1e1ec69f6efafa039948091b3', //The public key associated with the group
